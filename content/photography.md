...
terms: 300€ (1 hour shooting approx, studio and other costs are paid by the client + 1 hour integration session after photoworks are ready) // 20 pictures in autor's processing // no retouching // // photo turnaround -- 2 weeks // booking a photoshoot takes place on an advance payment of 50% // raw files are not given or demonstrated to a client // publishing rights are reserved unless otherwise agreed 
